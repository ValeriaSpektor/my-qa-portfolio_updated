  ...
  return (
    <Section id="contact" className="bg-white">
      ...
      <div className="grid lg:grid-cols-5 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:+972528287872" className="text-lg font-medium text-dark-900 hover:text-primary-600 transition-colors">
                  +972 52 8287872
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:vlapin84@gmail.com" className="text-lg font-medium text-dark-900 hover:text-primary-600 transition-colors">
                  vlapin84@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://t.me/ValeriaSpektor" target="_blank" rel="noopener noreferrer" className="text-lg font-medium text-dark-900 hover:text-primary-600 transition-colors">
                  @ValeriaSpektor
                </a>
              </div>
            </div>
        ...
        >
          <form className="bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-sm" onSubmit={(e) => e.preventDefault()}>
